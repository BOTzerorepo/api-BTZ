                                                                    ...
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="font-size:38px;"><strong><span
                                                                                        style="font-size:38px; color:#020858;">Nuevo Mensaje de BotZero Landing</strong></span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span
                                                                                style="font-size:20px;">Detalle de la cotización:</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                                                    ...
                                                                                    <p style="margin: 0; font-size: 12px; text-align: center;">
                                                                                        ...
                                                                                        <p style="margin: 0; font-size: 12px; text-align: center;">
                                                                                            <span style="font-size:20px; color: gray; text-align: center;">
                                                                                                ...
                                                                                                <p>E-mail:  {{ $mail['email'] }} <br>
                                                                                                Celular: {{ $mail['phone'] }}
                                                                                                Observaciones:  {{$mail['observation']}}
                                                                                            </p>
