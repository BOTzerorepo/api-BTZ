...
<h5 style="text-align:left;margin: 0; font-family: sans-serif;text-transform: uppercase;">IMPO MULTIMODAL</h5>
...
<table style="font-family: sans-serif;text-transform: uppercase; font-size: small;" width="100%" border="0"  cellspacing="0" bordercolor="#999999" class="tablaContenido">
    ...
    <tr>
        <td align="left" colspan="1" ><strong>Booking: </strong></td>
        <td colspan="4" class="tdContenido">{{ $booking }}</td>
    </tr>
    <tr>
        <td align="left" colspan="1" ><strong>MBL/HBL </strong></td>
        <td colspan="4" class="tdContenido">{{ $bl_hbl }}</td>
    </tr>
    <tr>
    ...
    <tr>
        <td align="left" width="25%" class="tdContenidoItem"><strong>Agencia de Despacho:</strong></td>
