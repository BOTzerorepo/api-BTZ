                                                                    ...
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="font-size:38px;"><strong><span
                                                                                        style="font-size:38px; color:white">Nueva Expo Marítima</strong></span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                                    ...
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="font-size:22px;"><strong><span
                                                                                        style="font-size:22px; color: white;" >{{ $datos['trader'] }}
                                                                                    </span></strong></span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                                ...
                                                                                <div class="txtTinyMce-wrapper"
                                                                                    ...
                                                                                    <p
                                                                                        ...
                                                                                        <span >
                                                                                            ...
                                                                                            Considerar nueva carga para el cliente {{$datos['trader'] }}, datos a confirmar ya fueron solicitados al cliente, en breve vuelvo con los mismos:
                                                                                    ...
                                                                                    <table style="width: 100%;">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td style="background: white;">Trader:</td>
                                                                                            <td>{{$datos['trader'] }}</td>
                                                                                        </tr>
                                                                                        <tr >
                                                                                            <td >Shipper:</td>
                                                                                        ...
                                                                                        <tr style="background: white;">
                                                                                            <td>Nave y Viaje</td>
                                                                                            <td>{{$datos['vessel'] }} - {{$datos['voyage'] }}</td>
                                                                                        </tr>
                                                                                        <tr >
                                                                                            <td>Destino Final:</td>
                                                                                            <td>{{$datos['finalPoint'] }}</td>
                                                                                        </tr>
                                                                                        <tr style="background: white;">
                                                                                            <td>Observaciones:</td>
