        ...
        <table role="presentation" class="container" width="100%">
          <tr>
             <td class="center p-16" style="background:#e0e0e0;">
              <div class="tag">Nueva Expo Marítima</div>
          ...
          <tr>
            <td class="p-24">
              ...
              <table class="table" role="presentation" cellpadding="0" cellspacing="0">
                ...
                <tr><td class="tdk">Depósito de retiro</td><td class="tdv">{{ $datos['depositoRetiro'] ?? '-' }}</td></tr>
                ...
                <tr><td class="tdk">Destino final</td><td class="tdv">{{ $datos['finalPoint'] ?? '-' }}</td></tr>
