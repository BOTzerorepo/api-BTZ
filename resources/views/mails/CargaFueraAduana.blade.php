...
<head>
  ...
  <title>Carga fuera de zona de aduana</title>
  <meta name="x-preheader" content="Carga fuera de zona de aduana — Booking {{ $datos['booking'] ?? '-' }}."/>
...
<body>
  ...
  <span style="display:none !important;visibility:hidden;opacity:0;color:transparent;height:0;width:0;overflow:hidden;">
    {{ 'Carga fuera de zona de aduana — Booking ' . ($datos['booking'] ?? '-') . '.' }}
  </span>
        ...
        <table role="presentation" class="container" width="100%">
          <tr>
            <td class="center p-16" style="background:#e0e0e0;">
              <div class="tag">FUERA DE ZONA DE ADUANA</div>
            ...
            <td class="p-24">
              ...
              <table class="table" role="presentation" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td class="tdv" style="color:#1d944e;font-weight:700;">
