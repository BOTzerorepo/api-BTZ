...
<head>
  ...
  <title>Carga terminada</title>
  <meta name="x-preheader" content="Carga terminada — Booking {{ $datos['booking'] ?? '-' }}."/>
  ...
  <style>
    ...
    .tag{display:inline-block;background:#fdfdfd;color:#2563eb;font-size:12px;padding:4px 8px;border-radius:4px}
  ...
  <table class="wrapper" role="presentation" width="100%" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td>
        <table role="presentation" class="container" width="100%">
          <tr>
            <td class="center p-16" style="background:#d6d9f0;">
              <div class="tag">TERMINADA</div>
              <h1 class="h1" style="margin-top:6px;">Servicio finalizado.</h1>
              <p>Gracias por cargar con <strong>Total Trade Group</strong></p>
              <p class="center" style="margin:10px 0 0;">
                <a href="{{env('FRONT_URL').'/satisfaccion/satisfaccion_carga.php?cntr_number='.$datos['cntr'].'&booking='.$datos['booking']}}"
                   style="display:inline-block;padding:12px 18px;background:#10b981;color:#ffffff;border-radius:6px;font-size:14px;">
                  <strong>Completar Encuesta de Satisfacción</strong>
                </a>
              </p>
            ...
            <td class="p-24">
              ...
              <table class="table" role="presentation" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td class="tdv" style="color:#0f4f94;font-weight:700;">
              ...
              <!-- IMPORTANTE: se mantiene EXACTO el enlace de encuesta -->
              

              <p class="center muted" style="margin:16px 0 0;">
