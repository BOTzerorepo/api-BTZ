...
<head>
  ...
  <title>Carga ingresada a stacking</title>
  <meta name="x-preheader" content="Carga ingresada a stacking — Booking {{ $datos['booking'] ?? '-' }}."/>
...
<body>
  ...
  <span style="display:none !important;visibility:hidden;opacity:0;color:transparent;height:0;width:0;overflow:hidden;">
    {{ 'Carga ingresada a stacking — Booking ' . ($datos['booking'] ?? '-') . '.' }}
  </span>
        ...
        <table role="presentation" class="container" width="100%">
          <tr>
            <td class="center p-16" style="background:#e0e0e0;">
              ...
              <h1 class="h1" style="margin-top:6px;">La carga ingresó a lugar de descarga {{ $datos['unload_place'] }}</h1>
