...
<head>
  ...
  <style>
    ...
    img { border:0; display:block; margin:0 auto; } /* centrado automático */
    ...
    .h1 { font-size:20px; line-height:1.3; color:#1f2937; margin:16px 0 8px; }
        ...
        <table role="presentation" class="container" width="100%">
          <tr>
            <td class="center p-24">
              <img src="https://btz.ar/ttg_mails.svg" alt="BOTzero" width="240" style="max-width:100%; height:auto;"/>
            </td>
          </tr>
        </table>
      </td>
          ...
          <tr>
            <td class="center p-16">
              <a href="https://botzero.tech" target="_blank">
                <img src="https://btz.ar/logo_mails.png" alt="BOTzero" width="120" style="max-width:100%; height:auto;"/>
              </a>
