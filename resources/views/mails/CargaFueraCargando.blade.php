...
<head>
  ...
  <title>Carga fuera de zona de carga</title>
  <meta name="x-preheader" content="Carga fuera de zona de carga — Booking {{ $datos['booking'] ?? '-' }}."/>
...
<body>
  ...
  <span style="display:none !important;visibility:hidden;opacity:0;color:transparent;height:0;width:0;overflow:hidden;">
    {{ 'Carga fuera de zona de carga — Booking ' . ($datos['booking'] ?? '-') . '.' }}
  </span>
        ...
        <table role="presentation" class="container" width="100%">
          <tr>
            <td class="center p-16" style="background:#e0e0e0;">
              <div class="tag">FUERA DE ZONA DE CARGA</div>
              <h1 class="h1" style="margin-top:6px;">La unidad se encuentra fuera de {{ $datos['load_place'] }}.</h1>
            </td>
          </tr>
        </table>
      </td>
