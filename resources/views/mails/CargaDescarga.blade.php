...
<head>
  ...
  <title>Carga en zona de descarga</title>
  <meta name="x-preheader" content="Carga en zona de descarga — Booking {{ $datos['booking'] ?? '-' }}."/>
        ...
        <table role="presentation" class="container" width="100%">
          <tr>
            <td class="center p-16" style="background:#e0e0e0;">
              <div class="tag">EN ZONA DE DESCARGA</div>
              <h1 class="h1" style="margin-top:6px;">La unidad se encuentra en zona de descarga.</h1>

              <h1 class="h1">Carga cercana a {{ $datos['unload_place'] }}</h1>
            </td>
          </tr>
        </table>
      </td>
