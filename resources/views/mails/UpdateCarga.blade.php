                                                                    ...
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="font-size:38px;"><strong><span
                                                                                        style="font-size:38px; color:#4caf50;">Modificación Carga </strong></span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                                    ...
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="font-size:22px;"><strong><span
                                                                                        style="font-size:22px;">{{ $carga['trader'] }}
                                                                                    </span></strong></span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                                ...
                                                                                <div class="txtTinyMce-wrapper"
                                                                                    ...
                                                                                    <p
                                                                                        ...
                                                                                        <span >
                                                                                            ...
                                                                                            Se realizaron las modificaciones a la carga, los datos modificados son:

                                                                                        </span>
                                                                                        <br/>
                                                                                    </p>
                                                                                    <h1>Datos Modificados de la Carga</h1>
                                                                                    <table style="width: 100%;">
                                                                                        @foreach ($modificacionesCarga as $field => $values)
                                                                                            <tr style="{{ $loop->iteration % 2 == 0 ? 'background: white;' : '' }}">
                                                                                                <td style="width: 30%;">{{ ucfirst($field) }} (Original):</td>
                                                                                                <td>{{ $values['original'] }}</td>
                                                                                            </tr>
                                                                                            <tr style="{{ $loop->iteration % 2 == 0 ? 'background: white;' : '' }}">
                                                                                                <td style="width: 30%;">{{ ucfirst($field) }} (Modificado):</td>
                                                                                                <td>{{ $values['nuevo'] }}</td>
                                                                                            </tr>
                                                                                        @endforeach
                                                                                    </table>
                                                                                
                                                                                    <h1>Datos Modificados del CNTR</h1>
                                                                                    <table style="width: 100%;">
                                                                                        @foreach ($modificacionesCntr as $field => $values)
                                                                                            <tr style="{{ $loop->iteration % 2 == 0 ? 'background: white;' : '' }}">
                                                                                                <td style="width: 30%;">{{ ucfirst($field) }} (Original):</td>
                                                                                                <td>{{ $values['original'] }}</td>
                                                                                            </tr>
