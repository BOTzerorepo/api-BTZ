                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                        class="row-content stack" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #d6d9f0; background-image:url('{{ asset('image/AlertasMails/danger.png') }}'); background-position: top center; background-repeat: no-repeat; color: #000000; width: 650px;"
                                        width="650">
                                                                    ...
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="font-size:25px;"><strong><span
                                                                                        style="font-size:28px; color:white;">CARGA CON PROBLEMA</strong></span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
