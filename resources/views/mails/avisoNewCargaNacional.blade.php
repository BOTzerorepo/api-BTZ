...
<head>
  ...
  <title>Nueva Carga Nacional</title>
  <meta name="x-preheader" content="Nueva Carga Nacional para {{ $datos['trader'] ?? 'cliente' }} — detalles y estado."/>
...
<body>
  ...
  <span style="display:none !important;visibility:hidden;opacity:0;color:transparent;height:0;width:0;overflow:hidden;">
    {{ 'Nueva Carga Nacional para ' . ($datos['trader'] ?? 'cliente') . ' — detalles y estado.' }}
  </span>
        ...
        <table role="presentation" class="container" width="100%">
          <tr>
            <td class="center p-24">
              <!-- Podés reemplazar por el logo local: {{ asset('image/CorreoAutomaticoTrans.png') }} -->
        ...
        <table role="presentation" class="container" width="100%">
          <tr
            <td class="center p-16" style="background:#e0e0e0;">
              <div class="tag">Nueva Carga Nacional</div>
          ...
          <tr>
            <td class="p-24">
              ...
              <table class="table" role="presentation" cellpadding="0" cellspacing="0">
                ...
                <tr class="row-alt"><td class="tdk">Cliente</td><td class="tdv">{{ $datos['shipper'] ?? '-' }}</td></tr>
                ...
                <tr><td class="tdk">Fecha de Entrega</td><td class="tdv">{{ $datos['cutOffFisico'] ?? '-' }}</td></tr>
              ...
              <!-- CTA opcional (si la enviás en $datos) -->
